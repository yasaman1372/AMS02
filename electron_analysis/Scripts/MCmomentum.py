...
# -*- coding: utf-8 -*-
"""
Created on Wed May 18 16:38:05 2022
...
def handle_file(arg):
    ...
    #cut = [TofVelocity,UpperTofCharge,TrdActiveLayers,InnerTrackerCharge,TrackerChiSquareY,TrdTrackEcalMatch,
            # TrackerTrackEcalMatch,TrackerHitPattern,ERmatching,ElectronEcalCut]
    

    cut = [TofVelocity,UpperTofCharge,TrdActiveLayers,InnerTrackerCharge,TrackerChiSquareY,TrdTrackEcalMatch,
             TrackerTrackEcalMatch,TrackerHitPattern,ERmatching]

    bin2_num = len(var2_binning) -1
    Events = np.zeros((len(cut),bin1_num, bin2_num))
    
    

    # names = ['TofVelocity','UpperTofCharge','TrdActiveLayers','InnerTrackerCharge','TrackerChiSquareY','TrdTrackEcalMatch',
    #      'TrackerTrackEcalMatch','TrackerHitPattern','ERmatching','ElectronEcalCut']
