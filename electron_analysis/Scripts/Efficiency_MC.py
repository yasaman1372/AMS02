...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  1 17:02:08 2023
...
def handle_file(arg):
    ...
    for events in read_tree(filename, treename, chunk_size=chunk_size, rank=rank, nranks=nranks):
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins=(var1_binning,var2_binning),weights=ak.to_numpy(UTTevents_passed.McEventWeightElectron))      
        UTTEvents_passed += hist_passed   
        
        hist, edges = np.histogramdd((v1,v2), bins=(var1_binning,var2_binning), weights=ak.to_numpy(UTTevents.McEventWeightElectron))        
        UTTEvents += hist
        #######
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning),weights=ak.to_numpy(UTCCevents_passed.McEventWeightElectron))        
        UTCCEvents_passed += hist_passed    
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning),weights=ak.to_numpy(UTCCevents.McEventWeightElectron))         
        UTCCEvents += hist
        
        ########################################################## selection cuts #################################################################
        
        ################### TOF beta #########################
        TBevents = ApplyPreselectionCuts(events)
        TBevents = NegativeRigidityTag(TBevents)
        
        #selection cuts
        TBevents = CutTrdActiveLayers(TBevents)
        TBevents = CutTrdNoHelium(TBevents)
        TBevents = CutTrackerPatternSortedByMDR(TBevents)
        TBevents = CutTrackerCharge(TBevents)
        TBevents = CutTrackerChiSquareY(TBevents)
        
        #identification cuts
        TBevents = ApplyIdentificationCuts(TBevents, data_type="MC")
        
        #other cuts
       
        EcalBDT = Ecal_BDT_cut(TBevents.EcalEnergyElectronNewMaximumShower)
        TBevents = TBevents[TBevents.EcalBDT_v7_EnergyD > EcalBDT ]
        
        TBevents_passed = CutTofBeta(TBevents)
        
        v1 = ak.to_numpy(TrdLRElecProt_Energy_HybridHits_TrdP(TBevents))
        v2 = ak.to_numpy(TBevents[var2_name])
        
        v1_passed = ak.to_numpy(TrdLRElecProt_Energy_HybridHits_TrdP(TBevents_passed))
        v2_passed = ak.to_numpy(TBevents_passed[var2_name])
        
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TBevents_passed.McEventWeightElectron))        
        TBEvents_passed += hist_passed    
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TBevents.McEventWeightElectron))         
        TBEvents += hist
        ...
        EALevents = CutEcalChiSquareLateralNormalized(EALevents, "MC")
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(EALevents_passed.McEventWeightElectron))        
        EALEvents_passed += hist_passed    
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(EALevents.McEventWeightElectron))         
        EALEvents += hist
        ...
        #identification cuts
        THevents = ApplyIdentificationCuts(THevents,data_type="MC")
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(THevents_passed.McEventWeightElectron))        
        THEvents_passed += hist_passed  
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(THevents.McEventWeightElectron))         
        THEvents += hist
        ...
        #identification cuts
        TPevents = ApplyIdentificationCuts(TPevents, data_type="MC")
        ...
        v1 = ak.to_numpy(TrdLRElecProt_Energy_HybridHits_TrdP(TPevents))
        v2 = ak.to_numpy(TPevents[var2_name])
        
        v1_passed = ak.to_numpy(TrdLRElecProt_Energy_HybridHits_TrdP(TPevents_passed))
        v2_passed = ak.to_numpy(TPevents_passed[var2_name])

        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TPevents_passed.McEventWeightElectron))        
        TPEvents_passed += hist_passed  
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TPevents.McEventWeightElectron))         
        TPEvents += hist
        ...
        TTGevents = CutEcalChiSquareLateralNormalized(TTGevents, "MC")
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TTGevents_passed.McEventWeightElectron))        
        TTGEvents_passed += hist_passed    
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TTGevents.McEventWeightElectron))         
        TTGEvents += hist
        ...
        #identification cuts:
        TCHevents = ApplyIdentificationCuts(TCHevents, data_type="MC")  
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TCHevents_passed.McEventWeightElectron))        
        TCHEvents_passed += hist_passed    
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TCHevents.McEventWeightElectron))         
        TCHEvents += hist
...
################################################################## identification cuts #################################################################        
    ...
    ###########################Energy rigidity matching############################
        ...
        #identification cuts
        ERMevents = CutEcalChiSquareLateralNormalized(ERMevents, "MC")
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(ERMevents_passed.McEventWeightElectron))        
        ERMEvents_passed += hist_passed    
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(ERMevents.McEventWeightElectron))         
        ERMEvents += hist
    ...
    ####################### CutEcalChiSquareLateralNormalized #######################
        ...
        ECevents_passed = CutEcalChiSquareLateralNormalized(ECevents, "MC")
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(ECevents_passed.McEventWeightElectron))        
        ECEvents_passed += hist_passed    
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(ECevents.McEventWeightElectron))         
        ECEvents += hist
    ...
    ############################# Tracker ECAL matching in X-projection ####################
        ...
        TEMXevents = CutEcalChiSquareLateralNormalized(TEMXevents, "MC")
        TEMXevents = CutTrackerTrackEcalCogDeltaY(TEMXevents)
        
        #other cuts
        #TEMevents = GeomagneticCutoff(TEMevents)
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TEMXevents_passed.McEventWeightElectron))        
        TEMXEvents_passed += hist_passed    
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TEMXevents.McEventWeightElectron))         
        TEMXEvents += hist
    ...
    ############################# Tracker ECAL matching in Y-projection ####################
        ...
        TEMYevents = CutEcalChiSquareLateralNormalized(TEMYevents, "MC")
        ...
        hist_passed, edges_passed = np.histogramdd((v1_passed,v2_passed), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TEMYevents_passed.McEventWeightElectron))        
        TEMYEvents_passed += hist_passed    
        
        hist, edges = np.histogramdd((v1,v2), bins= (var1_binning,var2_binning), weights=ak.to_numpy(TEMYevents.McEventWeightElectron))         
        TEMYEvents += hist        
