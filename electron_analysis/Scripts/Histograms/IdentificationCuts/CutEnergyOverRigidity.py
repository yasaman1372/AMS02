...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 12 22:18:03 2022
...
Histogram_branches = ["EcalEnergyDepositedMaximumShower","TrackerTrackChoutkoMaxSpanRigidity",
                      "EcalEnergyElectronNewMaximumShower", "McEventWeightElectron", "TrackerPattern"]
...
def main():
    ...
    parser.add_argument("--data_type", default="MC", help="type of the input data (e.g. ISS)")
    ...
    plot.set_ylabel("E / |R|", fontsize = 26)
    plot.set_xscale("log")
    ...
    plt.axhline(y = 10 ,linestyle=':',color='k',linewidth=5)
    figure.savefig("EnergyOverRigidity.pdf" , dpi=250)
    plt.close(figure)
