...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 27 10:45:27 2023
...
Hist_branches = ["EcalBDT3D",'ElectronCCMVABDT',"TrackerTrackChoutkoMaxSpanRigidity","EcalEnergyElectronNewMaximumShower", "TrdPLikelihoodHybridHitsElectronECAL", 
...
def handle_file(arg):
    ...
    var3_name = "EcalEnergyElectronNewMaximumShower" 
    ...
    for events in read_tree(filename, treename, chunk_size=chunk_size, rank=rank, nranks=nranks):
        ...
        v4_st = np.sign(ak.to_numpy(events_st["TrackerTrackChoutkoMaxSpanRigidity"]))
        ...
        v4_mt = np.sign(ak.to_numpy(events_mt["TrackerTrackChoutkoMaxSpanRigidity"]))
        ...
        v4_all = np.sign(ak.to_numpy(events_all["TrackerTrackChoutkoMaxSpanRigidity"]))

        hist_values_st, edges_st = np.histogramdd((v1_st,v2_st,v3_st,v4_st), bins= (var1_binning, var2_binning, var3_binning, var4_binning))        
    ...
    np.savez(os.path.join(resultdir, f"results_{rank}.npz"), var1_binning=var1_binning, var2_binning=var2_binning, var3_binning=var3_binning, var4_binning=var4_binning, 
...
def main():
    ...
    np.savez(os.path.join(args.resultdir, "results.npz"), var1_binning=var1_binning, var2_binning=var2_binning, var3_binning = var3_binning, var4_binning=var4_binning,
             Events_st = Events_st, Events_mt = Events_mt, Events_all = Events_all)
    ...
    #     figure.savefig("2D_histogram_CCMVABDT_TRD_Estimators.pdf" , dpi=250)
