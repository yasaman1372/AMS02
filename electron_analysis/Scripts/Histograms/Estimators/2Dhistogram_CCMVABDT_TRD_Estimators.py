...
def main():
    ...
    for binn in range(len(var3_binning) -1):
        ...
        events = np.ma.masked_where(signed_data_st <= 1, signed_data_st).transpose()
        ...
        figure.savefig("2D_histogram_CCMVABDT_TRD_Estimators_single_"+str(binn)+".pdf" , dpi=250)
       ...
       # plot.plot([],[],' ',label="Energy range = [20,50] Gev")
        ...
        figure.savefig("2D_histogram_CCMVABDT_TRD_Estimators_projection_"+str(binn)+".pdf" , dpi=250)
